...
function changeBgBody() {
  document.body.style.backgroundColor = bgBody[count];
}
...
function scurb({ clientX }) {
  song.currentTime = ((clientX - progres.getBoundingClientRect().left) / progres.offsetWidth) * song.duration;
}
